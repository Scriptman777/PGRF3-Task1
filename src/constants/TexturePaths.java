...
public class TexturePaths {
    ...
    public static final String LAVAWORLD2 = "./textures/lavaworld2.png";
    public static final String METAL = "./textures/metal.png";
    public static final String MOSS = "./textures/moss.png";
    public static final String PSYCHEDELIC = "./textures/psychedelic.png";
    public static final String SKY = "./textures/sky.png";
